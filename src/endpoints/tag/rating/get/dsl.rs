...
use crate::common::{fallible::Fallible, profile::account_id::AccountId, tag::{hierarchy::TagHierarchy, non_top_tag::NonTopTagId, proposal_operation::ProposalOperation, relation::{validate_tag_relation, TagRelation}}};

pub(crate) trait GetTagRelationRating {
    async fn get_tag_relation_rating(&self, account_id: AccountId, subtag_id: NonTopTagId, supertag_id: NonTopTagId, relation: TagRelation) -> Fallible<Option<ProposalOperation>, GetTagRelationRatingError> {
