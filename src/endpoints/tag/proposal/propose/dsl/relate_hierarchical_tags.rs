...
pub(crate) trait RelateHierarchicalTags {
    async fn relate_hierarchical_tags(&self, subtag_id: NonTopTagId, subtag_name: TagName, supertag_id: NonTopTagId, supertag_name: TagName, relation: TagRelation) -> Fallible<(), RelateHierarchicalTagsError> {
        match relation {
...
#[derive(Debug, Error)]
pub enum RelateHierarchicalTagsError {
